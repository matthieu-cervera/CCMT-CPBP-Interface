...
'''
Hyperparameter parsing - using argparse and parameter module
'''
...
if args.phase == 1 :
    hparam_file = os.path.join(os.getcwd(), "hparams-train-1stphase.yaml")
elif args.phase == 2 :
    hparam_file = os.path.join(os.getcwd(), "hparams-train-2ndphase.yaml")
else:
    if not args.constraints:
        hparam_file = os.path.join(os.getcwd(), "hparams.yaml")
    else:
        hparam_file = os.path.join(os.getcwd(),"hparams-gen.yaml")
